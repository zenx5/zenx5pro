...
export default function ArticleSkeleton() {
    ...
    return <CardPing className="col-span-1 md:col-start-3 col-start-1" isContent h-fit>
        ...
        {[1,2,3,4].map( (number:any, index:number) => <div className="flex py-2 flex-col gap-2" key={index}>
            <span className="h-5 bg-gray-300 w-3/4"></span>
            <span className="h-5 bg-gray-300 w-1/2"></span>
